...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slide.main_label'
        db.add_column(u'theme_slide', 'main_label',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Slide.sub_label'
        db.add_column(u'theme_slide', 'sub_label',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slide.main_label'
        db.delete_column(u'theme_slide', 'main_label')

        # Deleting field 'Slide.sub_label'
        db.delete_column(u'theme_slide', 'sub_label')
