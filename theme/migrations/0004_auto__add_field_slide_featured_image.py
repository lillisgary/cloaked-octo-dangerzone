...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slide.featured_image'
        db.add_column(u'theme_slide', 'featured_image',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slide.featured_image'
        db.delete_column(u'theme_slide', 'featured_image')
    ...
    models = {
        ...
        u'theme.slide': {
            ...
            '_order': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'active_image': ('mezzanine.core.fields.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
